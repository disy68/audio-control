...
import hu.diskay.audiocontrol.service.store.FileVolumeStore;
import hu.diskay.audiocontrol.service.store.VolumeInformationOBjectStore;
...
@PropertySource({
    ...
    "file:/${WORK_DIR}/config/database.properties"
})
@Import({
...
public class ApplicationConfig {
    ...
    public VolumeStore volumeStore() {
        String storeDirectoryPath = PropertyReader.getString("store.directory.path", env);

        return new FileVolumeStore(storeDirectoryPath, new VolumeInformationOBjectStore());
    }
